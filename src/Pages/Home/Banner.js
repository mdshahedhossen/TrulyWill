      ...
      <div class="hero mx-h-screen">
        <div class="hero-content flex-col lg:flex-row-reverse">
          ...
          <div className=" max-w-lg px-2">
            <h1 class="text-[56px] font-bold font-press-start">
            ...
            <div className="">
              <button class="bg-[#3484F0] uppercase rounded-lg w-[191px] h-[54px] text-white font-bold hover:btn-success mr-4 my-4">
                start our trust
              </button>
              <button class="bg-[#3484F0] uppercase rounded-lg w-[191px] h-[54px] text-white font-bold hover:btn-success">
                start our will
              </button>
            </div>
          </div>
